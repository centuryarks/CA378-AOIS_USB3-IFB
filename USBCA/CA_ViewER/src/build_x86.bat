...
"C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\devenv.exe" /rebuild "Release|Win32" /out build.log ..\..\USBCAExtensionUnit\src\USBCAExtensionUnit_VS2022.sln
