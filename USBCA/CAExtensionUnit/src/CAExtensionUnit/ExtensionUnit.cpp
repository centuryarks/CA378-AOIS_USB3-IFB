// ExtensionUnit.cpp : Implementation of CExtensionUnit
...
STDMETHODIMP 
CExtensionUnit::get_PropertySize(
    ULONG PropertyId, 
    ULONG *pulSize)
{
    HRESULT hr = S_OK;
...
STDMETHODIMP
CExtensionUnit::get_PropertyRange( 
    ULONG PropertyId,
    ULONG ulSize,
    BYTE pMin[  ],
    BYTE pMax[  ],
